...
public class Myinfo extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		request.setCharacterEncoding("UTF-8"); // 넘어오는 데이터가 한글일때 깨지지않게 하기위해 사용
		...
		out.println("이름 : <input type='text' name = 'userName' value='"+memberOne.getUserName()+"'/><br>");
		out.println("<input type='submit' value = '수정하기'/>");
		out.println("<input type='reset' value = '취소하기'/> </form>");
		out.println("</body>");
		out.println("</html>");
